            ...
            <div class="d-flex col-md justify-content-center">
                <div class="card bg-dark text-light" style="min-width: 40rem;">
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <img src="<?php echo '../avatar_user/' . $info['avatar']; ?>" alt="Avatar"
                                style="width: 200px; height: 200px; border-radius: 30%;">
                        </div>
                        ...
                        <div class="d-flex justify-content-around">
                            ...
                            <div class="text-end" style="min-width: 10rem;">
                                ...
                                <input type="text" class="form-control" id="nameInput" style="display: none;"
                        ...
                        <div class="d-flex justify-content-around">
                            ...
                            <div class="text-end" style="min-width: 10rem;">
                                ...
                                <input type="email" class="form-control" id="emailInput" style="display: none;"
                        ...
                        <div class="d-flex justify-content-around">
                            ...
                            <div class="text-end" style="min-width: 10rem;">
                                ...
                                <input type="text" class="form-control" id="phoneInput" style="display: none;"
                        ...
                        <div class="text-center mt-3">
                            ...
                            <button class="btn btn-danger float-start" id="cancelBtn"
