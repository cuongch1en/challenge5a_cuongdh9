...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 fixed-top">
        <div class="container">
            <a href="./page_user.php" class="navbar-brand">CUONGDH9</a>
            ...
            <div class="collapse navbar-collapse" id="navmenu">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <div class="dropdown">
                            <button class="btn btn-dark dropdown-toggle" type="button" id="profile"
                    ...
                    <li class="nav-item">
                        <a class="btn btn-dark" href="./show_challenge.php" role="button">My challenge</a>
                    </li>
                    <li class="nav-item">
