                                ...
                                <tbody>
                                    <?php foreach($challenges as $key => $challenge): ?>
                                        <tr>
                                            ...
                                            <td><a href="challenge_page.php?id=<?php echo $challenge['id']; ?>"><?php echo $challenge['challenge_name']; ?></a></td>
                                            <td><?php echo $challenge['hint']; ?></td>
                                            <td>
                                                <a href="challenge_page.php?id=<?php echo $challenge['id']; ?>" class="btn btn-primary btn-sm">Submit</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
