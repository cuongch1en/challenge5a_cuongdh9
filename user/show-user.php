...
$select = "SELECT * FROM user WHERE type = ?";
                ...
                <div class="card bg-dark text-light" style="min-width: 45rem;">
                    <div class="card-body d-flex align-items-center">
                        <div class="avatar" style="flex: 0 0 100px; margin-right: 40px;">
                            <img src="<?php echo '../avatar_user/' . $user['avatar']; ?>" alt="Avatar"
                                style="width: 150px; height: 150px; border-radius: 40%;">
                        </div>
                        <div class="user-info flex-grow-1">
                            ...
                            <div class="d-flex justify-content-end">
                                <div class="text-end" style="min-width: 10rem;">
                                    ...
                                    <button class="btn btn-primary btn-give-message" data-bs-toggle="modal"
                                        data-bs-target="#messageModal_<?php echo $user['id']; ?>">Give a message</button>

                                </div>
                            </div>
                            <div class="modal fade" id="messageModal_<?php echo $user['id']; ?>" tabindex="-1"
                                aria-labelledby="messageModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="messageModalLabel"><strong
                                                    style="color: black;">Give a message for
                                                    <?php echo $user['username']; ?></strong></h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <form id="messageForm_<?php echo $user['id']; ?>" action="process_message.php"
                                                method="POST">
